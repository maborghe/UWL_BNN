...
\begin{figure}[!t]
	...
	\includegraphics[width=\linewidth]{images/histo_CNN_all_real+fake.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}{0.30\textwidth}
	\includegraphics[width=\linewidth]{images/histo_BNN_all_real+fake.png}
        \caption{}
    \end{subfigure}
	\begin{subfigure}{0.30\textwidth}
	\includegraphics[width=\linewidth]{images/histo_Custom_all_real+fake.png}
        \caption{}
    \end{subfigure}
